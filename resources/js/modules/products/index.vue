    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="sm:rounded-lg">
        ...
        <div class="mt-6 p-6 shadow-sm bg-white border-b border-gray-200">
          ...
          <List v-if="viewMode === 'list'" :products="products" :removeAction="remove" />
          <Grid v-if="viewMode === 'grid'" :products="products" :removeAction="remove" />

          <div v-if="noProducts" class="text-lg">
