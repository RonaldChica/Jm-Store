    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="sm:rounded-lg">
        ...
        <div class="mt-6 p-6 shadow-sm bg-white border-b border-gray-200">
          ...
          <List v-if="viewMode === 'list'" :banks="banks" :removeAction="remove" />
          <Grid v-if="viewMode === 'grid'" :banks="banks" :removeAction="remove" />

          <div v-if="noBanks" class="text-lg">
...
export default {
  ...
  methods: {
    ...
    remove (id) {
      this.$inertia.delete(this.route('banks.destroy', id))
    }
  }
};
</script>
